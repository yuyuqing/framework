...
WORD32 CMsgMemPool::Initialize()
{
    ...
    m_atPool[0].pMemPool->Initialize(E_MemBufPowerNum_256, E_MemSizeType_256);
    ...
    m_atPool[1].pMemPool->Initialize(E_MemBufPowerNum_512, E_MemSizeType_512);
    ...
    m_atPool[2].pMemPool->Initialize(E_MemBufPowerNum_01K, E_MemSizeType_01K);
    ...
    m_atPool[3].pMemPool->Initialize(E_MemBufPowerNum_04K, E_MemSizeType_04K);
    ...
    m_atPool[4].pMemPool->Initialize(E_MemBufPowerNum_16K, E_MemSizeType_16K);
    ...
    m_atPool[5].pMemPool->Initialize(E_MemBufPowerNum_64K, E_MemSizeType_64K);
...
CLogMemPool::CLogMemPool (CCentralMemPool &rCentralMemPool)
    : CObjectMemPool<POWER_OF_MEMPOOL>(rCentralMemPool)
{
}
...
{
    return CObjectMemPool<POWER_OF_MEMPOOL>::Initialize(POWER_OF_MEMPOOL,
                                                        LOG_MEM_BUF_SIZE);
}
